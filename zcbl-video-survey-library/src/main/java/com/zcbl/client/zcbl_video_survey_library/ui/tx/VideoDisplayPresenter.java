...
public class VideoDisplayPresenter {
    ...
    private IRTCRoomListener irtcRoomListener ;
    ...
    public VideoDisplayPresenter(Context context, RoomManager roomManager) {
        ...
        irtcRoomListener = new RoomListenerCallback(null);
    }
    ...
    public TXLivePusher getTXLivePush() {
    ...
    private void getRemoteStream() {
        mRoomManager.updatePushers(mHttpRequest,irtcRoomListener);
    }
    ...
    private class RoomListenerCallback implements IRTCRoomListener {
        ...
        public void onDebugLog(final String line) {
            Log.e(ZCBLConstants.TAG, "onDebugLog: "+line);
            if(roomMemberEventListener != null)
                handler.post(new Runnable() {
                    @Override
                    public void run() {
